...
export default function PreviewPanel() {
  ...
  return (
    <div className="flex flex-col h-full relative bg-slate-950 select-none overflow-hidden">
      ...
      <div className="absolute top-4 left-0 right-0 flex justify-center z-20 pointer-events-none px-4">
        <div className="bg-slate-900/95 backdrop-blur-md px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-slate-800 shadow-xl flex items-center gap-2 sm:gap-3 pointer-events-auto transition-all">
          ...
          <button 
            ...
            className="flex items-center gap-1.5 text-xs font-bold text-slate-400 hover:text-red-400 transition-colors uppercase tracking-tight px-2 py-1 rounded-lg hover:bg-red-950/40 cursor-pointer" 
      ...
      >
        <div 
          className="origin-top transition-transform duration-150 ease-out shadow-2xl bg-white rounded-xs mb-12 border border-slate-800 shrink-0 cursor-pointer group/canvas hover:ring-2 hover:ring-blue-500/50"
          style={{ 
          ...
          title="Click any section to edit in the form"
        >
